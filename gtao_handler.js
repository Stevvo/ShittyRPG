...
function setPedCharacter(ent) {
         ...
         API.getEntityModel(ent) == -1667301416)) // FreemodeFemale
    {
		...
		if ((API.hasEntitySyncedData(ent, "GTAO_BEARD")) && (API.getEntityModel(ent) == 1885233650))
        {
			...
			API.callNative("_SET_PED_HEAD_OVERLAY_COLOR", ent, 1, 1, beardColor,beardColor);
		}
        ...
        if (API.hasEntitySyncedData(ent, "GTAO_MAKEUP"))
        {
            ...
            API.callNative("SET_PED_HEAD_OVERLAY", ent, 8, lipstick, API.f(1));        
            API.callNative("_SET_PED_HEAD_OVERLAY_COLOR", ent, 4, 0, makeupColor, makeupColor);
        }
